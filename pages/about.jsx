...
export default function About() {
  return (
    <div>
      <p>
        Welcome to [company name], a healthcare company on a mission to improve the overall health and well-being of humanity.
        ...
        At [company name], we believe that a healthy world starts with healthy individuals, and we&apos;re committed to empowering people
        ...
        Join us on our journey to a healthier world and experience the difference for yourself. Try [company name] multivitamin today!
      </p>
    </div>
  )
}
